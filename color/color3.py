...
def main():
    ...
    # Red White and Cyan text
    #print('{} white {}'.format(crayons.red('red'), crayons.cayan('cayan'))) # format string (old ver of str templating)
    print(f"{crayons.red('red')} white {crayons.cayan('cayan')}")  # f-string (newest version of str templating)

    crayons.disable() # disables the crayons package

    # this line should NOT have color as crayons is disabled
    print(f"{crayons.red('red')} white {crayons.cayan('cayan')}")  # f-string (newest version of string templating)
